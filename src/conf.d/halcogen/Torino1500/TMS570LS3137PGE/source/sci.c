...
/* USER CODE BEGIN (28) */
    sciNotification(sciREG, vec);
/* we don't use halcogen code */
#if 0
/* USER CODE END */
    ...
    case 11U:
        /* receive */
        {   uint32 byte = (sciREG->RD & 0x000000FFU);
    ...
    case 12U:
        ...
        if (--g_sciTransfer_t[0U].length > 0U)
        {
            sciREG->TD = *g_sciTransfer_t[0U].data++;
        }
        else
        {
