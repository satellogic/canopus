...
PRIVILEGED_DATA /* SATELLOGIC !static */ volatile portTickType xTickCount 						= ( portTickType ) 0U;
...
PRIVILEGED_DATA /* SATELLOGIC !static */ volatile portBASE_TYPE xNumOfOverflows 					= ( portBASE_TYPE ) 0;
