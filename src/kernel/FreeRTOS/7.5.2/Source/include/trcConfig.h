...
#define EVENT_BUFFER_SIZE (15*1024) /* Adjust wrt. to available RAM */
...
#define NISR              7//5
#define NQueue            10
#define NSemaphore        18//10
#define NMutex            18//10

/* Maximum object name length for each class (includes zero termination) */
#define NameLenTask       15
#define NameLenISR        11//15
#define NameLenQueue      11//15
#define NameLenSemaphore  11//15
#define NameLenMutex      11//15
 ...
 *****************************************************************************/
#define TRACE_DESCRIPTION "Cubebug2 Trace"
 ...
 *****************************************************************************/
#define TRACE_DESCRIPTION_MAX_LENGTH 32
