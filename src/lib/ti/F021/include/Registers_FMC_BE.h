...
#ifndef REGISTERS_BE_H_
#define REGISTERS_BE_H_
...
typedef volatile struct FMC_REGISTERS
{
   ...
   */
   union FLOCK
   {
      uint32_t u32Register; /* Flash Lock Register, bits 31:0 */
      struct
      {
         uint32_t _FLOCK_Reserved_31_16 :16;/*!< Reserved, bits 31:16 */
         uint32_t ENCOM                 :16;/*!< Enable Command Registers, bits 15:0 */
      } FLOCK_BITS;
   } Flock;
